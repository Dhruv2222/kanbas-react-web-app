...
function WorkingWithArrays() {
  ...
  const deleteTodo = async (todo: { id: any; }) => {
    ...
    try {const response = await axios.delete(`${API}/${todo.id}`);
  ...
  const updateTodo = async () => {
    try {const response = await axios.put(`${API}/${todo.id}`, todo);
  ...
  return (
    <div>
      ...
      <h3>Updating completed and description of array:</h3>
